export const Hero = () => {
  return (
    <>
      <div className="w-full h-[400px] bg-[rgb(26,33,49)] absolute top-0 z-[-1] transform rotate-[-2deg] scale-x-[10] scale-y-[2] origin-bottom">test</div>
      <div>
